...
export default function CardInteractive() {
  return (
    <Card
      asChild
      padding="sm"
      className="max-w-sm w-full mx-auto transition-all duration-300 hover:glass-strong hover:shadow-glass-md cursor-pointer group"
    >
      <a href="#interactive-card-demo" className="block">
