      ...
      <div className="relative w-full border-b border-glass-border">
        {view === "preview" ? (
          <Card className="p-0 rounded-bl-none rounded-br-none overflow-hidden">
            <div
              className="relative flex items-center justify-center bg-gradient-to-br from-purple-400/20 to-pink-400/20 dark:from-purple-900/40 dark:to-blue-900/40"
          ...
          <div
            ...
            style={{ height: codeHeightStyle }}
          >
            <CodeBlock
              code={code}
              lang="tsx"
              showLineNumbers
              className="m-0 w-full h-full rounded-bl-none rounded-br-none"
            />
          </div>
        )}
      </div>
