  ...
  },
  {
    ...
    tokens: {
      light: {
        ...
        "--glass-blur": "14px",
        "--glass-shadow-sm": "0 8px 24px 0 rgba(15, 23, 42, 0.08)",
        "--glass-shadow-md": "0 18px 48px 0 rgba(15, 23, 42, 0.12)",
        "--glass-shadow-lg": "0 28px 80px 0 rgba(15, 23, 42, 0.16)",
        "--glass-bg-strong": "rgba(255, 255, 255, 0.84)",
        "--glass-border-strong": "rgba(148, 163, 184, 0.42)",
      ...
      dark: {
        ...
        "--glass-shadow-md": "0 20px 56px 0 rgba(2, 6, 23, 0.34)",
        "--glass-shadow-lg": "0 32px 88px 0 rgba(2, 6, 23, 0.42)",
        "--glass-bg-strong": "rgba(15, 23, 42, 0.82)",
        "--glass-border-strong": "rgba(148, 163, 184, 0.3)",
        "--glass-blur-strong": "20px",
        "--glass-bg-soft": "rgba(15, 23, 42, 0.52)",
  ...
  },
  {
    ...
    tokens: {
      light: {
        ...
        "--glass-border": "rgba(191, 150, 111, 0.28)",
        "--glass-shadow": "var(--glass-shadow-sm)",
        "--glass-blur": "14px",
        "--glass-shadow-sm": "0 8px 26px 0 rgba(120, 53, 15, 0.08)",
        "--glass-shadow-md": "0 18px 48px 0 rgba(120, 53, 15, 0.12)",
        ...
        "--glass-blur-strong": "20px",
        "--glass-bg-soft": "rgba(255, 244, 230, 0.58)",
      ...
      dark: {
        ...
        "--glass-bg": "rgba(54, 35, 24, 0.76)",
        "--glass-border": "rgba(212, 163, 115, 0.24)",
        "--glass-shadow": "var(--glass-shadow-sm)",
        "--glass-blur": "16px",
        "--glass-shadow-sm": "0 10px 28px 0 rgba(20, 10, 6, 0.3)",
        "--glass-shadow-md": "0 24px 60px 0 rgba(20, 10, 6, 0.38)",
        "--glass-shadow-lg": "0 34px 96px 0 rgba(20, 10, 6, 0.48)",
        "--glass-bg-strong": "rgba(69, 44, 29, 0.88)",
        "--glass-border-strong": "rgba(234, 179, 122, 0.3)",
        "--glass-blur-strong": "24px",
        "--glass-bg-soft": "rgba(41, 27, 19, 0.54)",
  ...
  },
  {
    ...
    tokens: {
      ...
      dark: {
        ...
        "--glass-bg": "rgba(91, 33, 75, 0.72)",
        "--glass-border": "rgba(244, 114, 182, 0.24)",
        "--glass-shadow": "var(--glass-shadow-md)",
        "--glass-blur": "18px",
        "--glass-shadow-sm": "0 12px 28px 0 rgba(79, 18, 62, 0.3)",
        "--glass-shadow-md": "0 26px 62px 0 rgba(49, 46, 129, 0.34)",
        "--glass-shadow-lg": "0 38px 104px 0 rgba(21, 94, 117, 0.38)",
        "--glass-bg-strong": "rgba(131, 24, 67, 0.84)",
        "--glass-border-strong": "rgba(103, 232, 249, 0.28)",
        "--glass-blur-strong": "24px",
        "--glass-bg-soft": "rgba(80, 7, 36, 0.5)",
  ...
  },
  {
    ...
    tokens: {
      light: {
        ...
        "--destructive": "#b91c1c",
        "--destructive-foreground": "#ffffff",
        "--glass-bg": "rgba(245, 245, 245, 0.76)",
        "--glass-border": "rgba(163, 163, 163, 0.24)",
        "--glass-shadow": "var(--glass-shadow-sm)",
        "--glass-blur": "12px",
        "--glass-shadow-sm": "0 8px 20px 0 rgba(38, 38, 38, 0.08)",
        "--glass-shadow-md": "0 18px 44px 0 rgba(38, 38, 38, 0.12)",
        ...
        "--glass-bg-soft": "rgba(229, 229, 229, 0.56)",
  ...
  },
  {
    ...
    tokens: {
      light: {
        ...
        "--destructive": "#b45309",
        "--destructive-foreground": "#fff7ed",
        "--glass-bg": "rgba(243, 248, 238, 0.8)",
        "--glass-border": "rgba(116, 153, 102, 0.24)",
        "--glass-shadow": "var(--glass-shadow-sm)",
        "--glass-blur": "14px",
        "--glass-shadow-sm": "0 8px 22px 0 rgba(63, 125, 78, 0.08)",
        "--glass-shadow-md": "0 18px 46px 0 rgba(63, 125, 78, 0.12)",
        "--glass-shadow-lg": "0 28px 82px 0 rgba(92, 114, 62, 0.16)",
        "--glass-bg-strong": "rgba(252, 255, 249, 0.9)",
        "--glass-border-strong": "rgba(63, 125, 78, 0.34)",
        "--glass-blur-strong": "20px",
        "--glass-bg-soft": "rgba(230, 241, 224, 0.58)",
  ...
  },
  {
    ...
    tokens: {
      ...
      dark: {
        ...
        "--glass-shadow-md": "0 24px 64px 0 rgba(2, 6, 23, 0.44)",
        "--glass-shadow-lg": "0 38px 110px 0 rgba(2, 6, 23, 0.56)",
        "--glass-bg-strong": "rgba(30, 41, 99, 0.88)",
        "--glass-border-strong": "rgba(129, 140, 248, 0.3)",
        "--glass-blur-strong": "26px",
        "--glass-bg-soft": "rgba(15, 23, 42, 0.56)",
