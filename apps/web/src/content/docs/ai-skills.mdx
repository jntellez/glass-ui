...
import SkillSourceLink from "@/components/docs/SkillSourceLink"
import Steps from "@/components/docs/Steps"
import { Badge, Card } from "@glass-ui-kit/glass"

<Card variant="soft" padding="sm" className="not-prose my-6">
  <p className="mb-2 font-mono text-xs font-semibold uppercase tracking-[0.16em] text-muted-foreground">
  ...
  <div className="mt-4 flex flex-wrap gap-1.5">
    <Badge size="sm">React 18+</Badge>
    <Badge size="sm">Tailwind CSS v4</Badge>
    <Badge size="sm">MIT</Badge>
  </div>
</Card>
...
<Card padding="sm" className="not-prose mt-6 sm:flex sm:items-center sm:justify-between sm:gap-4">
  <div>
