...
<CommandTabs
  npm="npx @glass-ui-kit/cli add native-select"
  pnpm="pnpm dlx @glass-ui-kit/cli add native-select"
  yarn="yarn dlx @glass-ui-kit/cli add native-select"
  bun="bunx @glass-ui-kit/cli add native-select"
  client:load
/>
